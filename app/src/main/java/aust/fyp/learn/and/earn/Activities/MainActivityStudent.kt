...
import aust.fyp.learn.and.earn.Fragments.Student.ClassRoomFragmentStudent
import aust.fyp.learn.and.earn.Fragments.Student.HomeFragmentStudent
...
class MainActivityStudent : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewPagerAdapter.addFragment(HomeFragmentStudent(), "Home")
        viewPagerAdapter.addFragment(InboxFragmentStudent(), "Inbox")
        viewPagerAdapter.addFragment(ClassRoomFragmentStudent(), "Class Room")
